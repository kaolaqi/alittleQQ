<template>
	<div class="login-page">
		<h1 class="title"><i class="cicon icon-return" @click="back"></i>注册alittleQQ</h1>
     	<div class="login-register-container">
            ...
            <div class="input-container">
                ...
                <input v-model="nickname" type="text" @blur="resize" placeholder="请输入昵称">
            </div>
            <div class="input-container">
            ...
            <div class="input-container">
                ...
                <input v-model="againPassword" type="password" @blur="resize" placeholder="再次填写密码">
            </div>
