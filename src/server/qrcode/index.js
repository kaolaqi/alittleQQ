...
a.prototype = {
  ...
  makeImpl: function(a, c) {
    ...
    this.setupPositionProbePattern(0, 0), this.setupPositionProbePattern(this.moduleCount - 7, 0), this.setupPositionProbePattern(0, this.moduleCount - 7), this.setupPositionAdjustPattern(), this.setupTimingPattern(), this.setupTypeInfo(a, c), this.typeNumber >= 7 && this.setupTypeNumber(a), this.dataCache == null && (this.dataCache = b.createData(this.typeNumber, this.errorCorrectLevel, this.dataList)), this.mapData(this.dataCache, c)
  },
  setupPositionProbePattern: function(a, b) {
    for (var c = -1; c <= 7; c++) {
      if (!(a + c <= -1 || this.moduleCount <= a + c)) { for (var d = -1; d <= 7; d++) b + d <= -1 || this.moduleCount <= b + d || (this.modules[a + c][b + d] = c >= 0 && c <= 6 && (d == 0 || d == 6) || d >= 0 && d <= 6 && (c == 0 || c == 6) || c >= 2 && c <= 4 && d >= 2 && d <= 4 ? !0 : !1) }
    }
  },
  ...
  setupTimingPattern: function() {
    ...
    for (var b = 8; b < this.moduleCount - 8; b++) this.modules[6][b] == null && (this.modules[6][b] = b % 2 == 0)
  },
    ...
    for (var a = f.getPatternPosition(this.typeNumber), b = 0; b < a.length; b++) {
      for (var c = 0; c < a.length; c++) {
        ...
        if (this.modules[d][e] == null) {
          for (var g = -2; g <= 2; g++) { for (var h = -2; h <= 2; h++) this.modules[d + g][e + h] = g == -2 || g == 2 || h == -2 || h == 2 || g == 0 && h == 0 ? !0 : !1 }
        }
      }
    }
  },
  ...
  for (g.getLengthInBits() + 4 <= 8 * l && g.put(0, 4); g.getLengthInBits() % 8 != 0;) g.putBit(!1)
  for (;;) {
...
for (var c = {
    ...
    getLostPoint: function(a) {
      for (var b = a.getModuleCount(), c = 0, d = 0; b > d; d++) {
        for (var e = 0; b > e; e++) {
          for (var f = 0, g = a.isDark(d, e), h = -1; h <= 1; h++) {
            if (!(d + h < 0 || d + h >= b)) { for (var i = -1; i <= 1; i++) e + i < 0 || e + i >= b || (h != 0 || i != 0) && g == a.isDark(d + h, e + i) && f++ }
          }
          f > 5 && (c += 3 + f - 5)
        }
      }
      for (var d = 0; b - 1 > d; d++) {
        for (var e = 0; b - 1 > e; e++) {
          var j = 0
          a.isDark(d, e) && j++, a.isDark(d + 1, e) && j++, a.isDark(d, e + 1) && j++, a.isDark(d + 1, e + 1) && j++, (j == 0 || j == 4) && (c += 3)
        }
      }
  ...
  }, h = 0; h < 8; h++) g.EXP_TABLE[h] = 1 << h
for (var h = 8; h < 256; h++) g.EXP_TABLE[h] = g.EXP_TABLE[h - 4] ^ g.EXP_TABLE[h - 5] ^ g.EXP_TABLE[h - 6] ^ g.EXP_TABLE[h - 8]
...
var q = p ? o : m() ? (function() {
  ...
  function d(a, b) {
    var c = this
    if (c._fFail = b, c._fSuccess = a, c._bSupportDataURI === null) {
  ...
  if (this._android && this._android <= 2.1) {
    ...
    CanvasRenderingContext2D.prototype.drawImage = function(a, d, e, f, g, h, i, j) {
      if ('nodeName' in a && /img/i.test(a.nodeName)) { for (var l = arguments.length - 1; l >= 1; l--) arguments[l] = arguments[l] * b } else typeof j === 'undefined' && (arguments[1] *= b, arguments[2] *= b, arguments[3] *= b, arguments[4] *= b)
...
var QRCode = function(a, b) {
  ...
  typeof a === 'string' && (a = document.getElementById(a)), this._android = n(), this._el = a, this._oQRCode = null, this._oDrawing = new q(this._el, this._htOption), this._htOption.text && this.makeCode(this._htOption.text)
